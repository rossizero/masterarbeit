...
\input{txt/motivation.tex}
\input{txt/scenarios.tex}
\input{txt/detailing.tex}
\input{txt/problem.tex}
\input{txt/aufgabe.tex}
\input{txt/basics.tex}
\input{txt/related.tex}
