...
Zudem gibt es speicherreduziertere Formate wie ifcZip oder für Menschen lesbarere Formate wie ifcXML~\cite{Industry93:online}\cite{IFCForma28:online}\cite{BIM_handbook_AEC_XML_SCHEMAS}.
...
Dies kann mithilfe von \textit{IfcPropertySets} und \textit{IfcQuantitySets} umgesetzt werden, welche Objekten oder Objekttypen angehängt werden können.
...
Im Falle des \textit{IfcWallType} existiert beispielsweise das PropertySet mit dem Namen \textit{Pset\_WallCommon}.
