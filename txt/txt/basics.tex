...
\begin{figure}[htb]
  ...
  \begin{subfigure}[b]{0.4\columnwidth}
    ...
    \caption{Schleppender Läuferverband \textit{(1/4 Versatz).}}
  \end{subfigure}
  \hspace*{\fill}%
  \begin{subfigure}[b]{0.4\columnwidth}
...
Dennoch kann dieser vernachlässigt und demnach als Abstand von \(0.0mm\) gewertet werden.
