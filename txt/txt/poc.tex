...
Vom ersten Typ, der eine 0,125 Meter dicke Wand aus 1 DF Steinen und halb versetztem Läuferverband vorschreibt, gibt es 20 Stück.
...
\begin{figure}[hbt]
  \hspace*{\fill}%
  \begin{subfigure}[b]{0.25\columnwidth}
    \includegraphics[width=\columnwidth]{fig/TODO.jpg}
  \end{subfigure}
  \hfill%
  \begin{subfigure}[b]{0.25\columnwidth}
    \includegraphics[width=\columnwidth]{fig/TODO.jpg}
  \end{subfigure}
  \hspace*{\fill}%
  \caption{Ergebnis des Szenario Fabrikgebäude mit 40409 Bausteinen.}\label{fig:poc:scenario3}
\end{figure}
