...
\begin{figure}[ht!]
  \begin{subfigure}[b]{0.3\columnwidth}
    ...
    \caption{STL-Datei des Beispiels.}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.6\columnwidth}
    \includegraphics[width=\columnwidth]{fig/real_export_ontology.drawio.png}
    \caption{Objektdiagramm der aus dem Beispiel generierten Individuen in der Ontologie. Nachbarschaften wurden zur Übersichtlichkeit abgekürzt (t: Top, b: Bottom, r: Right, l: Left).}
  \end{subfigure}
  \caption{Verschiedene Exportformate anhand eines einfachen Beispiels mit 6 Bausteinen. Dabei wurden die unteren Nachbarn jedes Bausteins mithilfe einer entsprechenden Regel in die \textit{dependsOn}-Eigenschaft übertragen (siehe Kapitel~\ref{concept:regelbasierte_bauplandeduktion}).}\label{fig:real:export}
\end{figure}