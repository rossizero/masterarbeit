...
%Gerade bei diesen Bereichen könnten Konzepte aus dem \textit{Bin Packing Problem} zum automatischen Finden passender Bausteinkonfigurationen herangezogen werden.
...
Das Lösen der kritischen Bereiche entspricht allerdings eher einem Problem, das mit \glqq{}intelligenten\grqq{} Optimierungsverfahren bewältigt werden kann. 
...
Das angestrebte LOD ist eine Art Mockup und ein Schritt vor dem letzten LOD, dem Baubestandsplan, der eine exakte Repräsentation der zu bauenden Elemente darstellt.
Das Ziel der Veröffentlichung ist dieses LOD direkt in der BIM Umgebung zu berechnen und anzuzeigen, da die dafür notwendigen Informationen darin ohnehin vorhanden sind.
