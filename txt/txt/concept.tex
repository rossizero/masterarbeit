...
Es werden nun für jede dieser vier Beziehungen Eigenschaften aufgezeigt anhander derer man diese in einer Menge an Wandstücken finden und unterscheiden kann.
...
Andernfalls würde jedes Wandstück den Mauerwerksverband unabhängig seiner Nachbarn neu beginnen und dadurch sehr wahrscheinlich fälschlicherweise unterbrechen.
...
Insgesamt bilden in dem Beispiel in Abbildung~\ref*{fig:concept:combination_example_base} demnach alle Wandstücke exklusive Wandstück Nummer 4 eine Einheit, die alle Punkte erfüllt.
