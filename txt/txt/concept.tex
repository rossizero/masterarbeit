...
Außerdem können dadurch unterschiedliche Raster auf verschiedenen Objekten eines Modells angewendet werden.
...
\begin{enumerate}
    ...
    \item Für jede Schicht eine Menge verschiedener Bausteintransformationen, bis diese sich (ebenfalls mit einem Versatz in X Richtung) wiederholen.
\end{enumerate}
...
Dort wurden zudem die verschiedenen Arten von Beziehungen, die für das nachfolgende \glqq{}Wall Detailing\grqq{} zu unterscheiden sind, thematisiert.
