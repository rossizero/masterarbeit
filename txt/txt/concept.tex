...
Dabei wiederholen sich sowohl die Bausteintransformationen innerhalb einer Schicht des Verbandes, als auch die Schichten selbst.
Daher sind folgende Informationen zur Beschreibung eines Mauerwerksverbands notwendig:
\begin{enumerate}
    \item Anzahl der verschiedenen Schichten, bis diese sich wiederholen.
    \item Für jede Schicht die Anzahl verschiedener Bausteintransformationen, bis diese sich wiederholen.
    \item Einen rotierenden sowie einen translativen Versatz für jede einzigartige Bausteintransformation innerhalb einer Schicht.
\end{enumerate}
