...
Darum bleibt zunächst nur das Durchprobieren sämtlicher Konfigurationen bis eine zulässige gefunden wurde.
...
Findet man für keinen Startknoten eine valide Lösung, so exisitiert für das Modell und den Modulen der gewünschten Mauerwerksverbände keine lückenlose Bausteinkonfiguration.
...
Das Ergebnis dieser Schritte ist eine Menge aus Bausteinen.
Durch die Berechnungen in Schrit~\ref{concept:wall_detailing_tmp2} werden bereits die grundlegensten Beziehungen zwischen den Bausteinen hergestellt.
