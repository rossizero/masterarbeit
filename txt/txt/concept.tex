...
\begin{figure}[htb]
  \centering
  \includegraphics[width=0.7\columnwidth]{fig/klassendiagramm_ontologie_bricks.drawio.png}
...
\begin{figure}[htb]
  ...
  \caption{Klassendiagramm der Ontologie zur Regelbeschreibung.}\label{fig:concept:ontologie_diagramm_bricks}
\end{figure}
