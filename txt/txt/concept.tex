...
\begin{itemize}
  ...
  Sie wird als Objekteigenschaft mit dem Namen \textit{dependOn} realisiert, deren Wertebereich (Range) Individuen der Klasse Brick sind.
...
Darum ist es notwendig bei der Befüllung der Ontologie mit den im Bauplanentwurf errechneten Baustein-Instanzen explizite Einschränkungen vorzugeben.
...
Falls dies nicht vorgenommen wird, kann ein Reasoner kein Individuum der Klasse NextBrick zuordnen, da es theoretisch sein könnte, dass ein anderer PlaceableBrick existiert, der der Abhängigkeits-Eigenschaft des Individuums zugeordnet ist.
